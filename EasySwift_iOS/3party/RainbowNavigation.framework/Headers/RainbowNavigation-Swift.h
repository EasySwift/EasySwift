...
SWIFT_PROTOCOL("_TtP17RainbowNavigation18RainbowColorSource_")
@protocol RainbowColorSource
@optional
- (UIColor * _Nonnull)navigationBarInColor;
- (UIColor * _Nonnull)navigationBarOutColor;
@end
...
SWIFT_CLASS("_TtC17RainbowNavigation17RainbowNavigation")
@interface RainbowNavigation : NSObject <UINavigationControllerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)wireToNavigationController:(UINavigationController * _Nonnull)nc;
...
@interface UINavigationBar (SWIFT_EXTENSION(RainbowNavigation))
- (void)df_setStatusBarMaskColor:(UIColor * _Nonnull)color;
- (void)df_setBackgroundColor:(UIColor * _Nonnull)color;
- (void)df_reset;
@end
