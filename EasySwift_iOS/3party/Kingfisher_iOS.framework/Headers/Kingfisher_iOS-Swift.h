...
*/
SWIFT_CLASS("_TtC14Kingfisher_iOS17AnimatedImageView")
...
*/
SWIFT_CLASS("_TtC14Kingfisher_iOS15ImageDownloader")
...
@interface ImageDownloader (SWIFT_EXTENSION(Kingfisher_iOS))
@end
...
SWIFT_CLASS("_TtC14Kingfisher_iOS29ImageDownloaderSessionHandler")
...
@interface NSMutableData (SWIFT_EXTENSION(Kingfisher_iOS))
/**
...
@interface UIApplication (SWIFT_EXTENSION(Kingfisher_iOS))
@end


@interface UIButton (SWIFT_EXTENSION(Kingfisher_iOS))
@end
...
@interface UIColor (SWIFT_EXTENSION(Kingfisher_iOS))
@end


@interface UIImage (SWIFT_EXTENSION(Kingfisher_iOS))
@end
...
@interface UIImageView (SWIFT_EXTENSION(Kingfisher_iOS))
@end
